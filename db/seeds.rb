...
# users = User.create(name: "Minh Hau",
#   password: "123123",
#   phone: "0787073046",
#   email: "hauminh@gmail.com",
#   address: "Da Nang")
...
# products = Product.create(name: "BLACK CAP",
...
# orders = Order.create(date_order: "2019-06-15",
#   address: "Hoa Tien - Da Nang",
#   note: "tra tien sau khi nhan hang",
#   user_id: 1 )

# histories = History.create(user_id: 1)

# order_details = OrderDetail.create(quanitily: 2,
#   price: 600000,
#   order_id: 1,
#   product_id: 1,
#   history_id:1 )
